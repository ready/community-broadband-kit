...
const config = {
    ...
    downloadworkerfile: "/static/test/m-lab/src/ndt7-download-worker.js",
    uploadworkerfile: "/static/test/m-lab/src/ndt7-upload-worker.js",
    metadata: {
 ...
 */
async function runMlabTest(handlerConfig) {
