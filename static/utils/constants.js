...
export const BOSS_PLATFORM_URL = BOSS_PLATFORM_GRAPHQL_API_URL;
...
export const survey = [
  ...
  },
  {
    id: 1,
    question:
      'What is the primary type of internet service used at this location?',
    type: 'radio',
    answers: [
      'Cable',
  ...
  },
  {
    id: 2,
    question:
      'Select the range which best describes which tier of service you are subscribed to.',
    type: 'nested',
    subquestions: [
      {
        question: 'Download:',
  ...
  },
  {
    id: 3,
    question:
      'Are you paying for the highest tier of service available from your provider?',
    type: 'radio',
  ...
  },
  {
    id: 4,
    question:
      'On average how many devices at your location use the internet at the same time?',
    type: 'select',
  ...
  },
  {
    id: 7,
    question:
      'How many people can use your current internet connection at once without any stalling, long waits for downloads, or other delays?',
    type: 'select',
  ...
  },
  {
    id: 8,
    question:
      'Does anyone at your location use the internet to complete school assignments or job training course work?',
    type: 'radio',
    answers: ['Yes', 'No'],
  ...
  },
  {
    ...
    answers: [
      ...
      'On video calls',
      'While loading pages on the internet',
    ],
  ...
  },
  {
    id: 14,
    question:
      'If you participate in video calls do you struggle with lagging and or dropping out of calls?',
    type: 'radio',
  ...
  },
  {
    id: 15,
    question:
      'What are your reasons for any dissatisfaction with your current internet service?',
    type: 'radio',
    answers: [
      'Price is too high',
  ...
  },
  {
    id: 17,
    question:
      'To the best of your knowledge, how much are you currently paying per month for internet access?',
    type: 'radio',
    answers: [
      'Under $30',
      '$30 to $49',
  ...
  },
  {
    id: 18,
    question:
      'How much (per month) would you be willing to pay for high-quality internet service that meets your needs/requirements?',
    type: 'radio',
    answers: [
      '$30 to $49',
      '$50 to $69',
  ...
  },
  {
    id: 19,
    question:
      'If you were offered to upgrade to a better service plan, how much more would you be willing to pay?',
    type: 'radio',
    answers: [
      "None, I wouldn't upgrade",
      'Less than $20',
      '$20 to $29',
      '$30 to $39',
      '$40 to $59',
  ...
  },
  {
    id: 20,
    question:
      'If you were offered a $30 per month credit toward your internet bill, would you use it?',
    type: 'radio',
    answers: ['Yes', 'No'],
  ...
  },
  {
    id: 21,
    question:
      'Considering your current expenses and needs, how much would you be willing to pay monthly for a 1 Gbps (gigabits per second) speed internet access at your location?',
    type: 'radio',
    answers: [
      '$30 to $49',
      '$50 to $69',
  ...
  },
  {
    id: 22,
    question:
      'Do you use cellular service at this location? (e.g. Verizon, T-Mobile, AT&T, US Cellular, Sprint, etc.)',
    type: 'radio',
    answers: [
      'Yes, for voice calls and internet data',
      'Yes, for voice calls only',
      'Yes, for internet data only',
      'No, I do not have cellular service here',
      'Not sure',
    ],
    attribute: 'usesCell',
    attributeType: 'string',
  },
  {
    id: 23,
    question:
      'How satisfied are you with the cellular service at this location?',
    type: 'radio',
    answers: [
      'Very satisfied',
      'Somewhat satisfied',
...
export const MAPBOX_TOKEN =
  'pk.eyJ1IjoicmVhZHlnZW8iLCJhIjoiY2t1emEybG85N2F6ZzJwbzNycWhkcjByeiJ9.Ego8nI7YHxkQMQNus_SFyw';
